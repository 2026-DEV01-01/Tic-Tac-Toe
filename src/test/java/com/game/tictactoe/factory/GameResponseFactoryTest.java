...
class GameResponseFactoryTest {
    ...
    void create_shouldMapAllFieldsCorrectly() {
        ...
        GameStatus expectedStatus = GameStatus.IN_PROGRESS;
        String expectedMessage = "Move accepted.";

        GameResponse actualResponse = factory.create(expectedBoard, expectedStatus, expectedMessage);
    ...
    void create_shouldHandleNullInputsSafely() {
        GameResponse actualResponse = factory.create(null, null, null);
